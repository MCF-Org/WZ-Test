...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/MCF-Org/WZ-Test"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/MCF-Org/WZ-Test'>@GitHub</a> By <a href='https://github.com/weebzone'>Code With Weeb</a></h1>"
